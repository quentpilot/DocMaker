 ...
 * @Filename:           SorterFactory.java
 * @Date:               2017-11-10T20:48:52+01:00
 * @Last modified by:   quentin
 * @Last modified time: 2017-11-10T23:18:18+01:00
 * @License:            MIT
 ...
 */
 ...
 public class SorterFactory extends Factory {

   public SorterFactory() {
     super();
   }

   public SorterFactory(ArrayList<Model> files) {
     super();
   ...
   */
   public boolean             build() {
     FilerModel info = new DatabaseFiler();
   ...
   */
   protected boolean             scan(FilerModel file) {
     this.setLexer(new Scanner(file));
     this.setLexer(new Builder(this.getLexer()));
     return true;
   }
