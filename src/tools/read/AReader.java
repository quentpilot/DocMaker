/**
 * @Description:        AReader abstract class is used to read current STDIN or file stream
...
public abstract class AReader {
    ...
    */
     ...
     * @see AReader#stream
     */
     public File[]         scan(String filepath) {
 		String 				path = "resources/database/http/json/"; //filepath
      ...
      * @see AReader#stream
      */
      public File[]         scanFile(String filepath) {
